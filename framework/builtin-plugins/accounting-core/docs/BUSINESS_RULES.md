# Accounting Core Business Rules

## Invariants

- The plugin remains authoritative only for the data declared in `accounting-core` and its owned resource set.
...
- The domain catalog currently tracks 9 owned entity surface(s), 8 report surface(s), and 5 exception queue(s).
