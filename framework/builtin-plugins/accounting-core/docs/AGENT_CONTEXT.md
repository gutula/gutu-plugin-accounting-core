...
- Package root: `framework/builtin-plugins/accounting-core`
- Service layer: `framework/builtin-plugins/accounting-core/src/services/main.service.ts`
- Action layer: `framework/builtin-plugins/accounting-core/src/actions/default.action.ts`
- Resource layer: `framework/builtin-plugins/accounting-core/src/resources/main.resource.ts`
- UI layer: `framework/builtin-plugins/accounting-core/src/ui`

## Safe assumptions

- Use `accounting-core` as the stable plugin identifier and `@plugins/accounting-core` as the package import name.
