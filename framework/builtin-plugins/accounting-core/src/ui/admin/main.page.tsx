...
export async function BusinessAdminPage() {
  ...
  return React.createElement(
    "section",
    null,
    React.createElement("h1", null, "Accounting Control Room"),
    React.createElement("p", null, "Ledger truth, posting intent handling, billing posture, and reconciliation visibility."),
    React.createElement(
      "p",
      null,
