...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/accounting-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-accounting-core:");
...
console.log("Documentation check passed for gutu-plugin-accounting-core.");
